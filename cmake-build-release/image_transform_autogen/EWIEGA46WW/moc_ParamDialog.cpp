...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_ParamDialog_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_ParamDialog_t qt_meta_stringdata_ParamDialog = {
    {
QT_MOC_LITERAL(0, 11), // "ParamDialog"
QT_MOC_LITERAL(12, 7), // "applied"
QT_MOC_LITERAL(20, 0) // ""

    },
    "ParamDialog\0applied\0"
};
...
void ParamDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (ParamDialog::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ParamDialog::applied)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject ParamDialog::staticMetaObject = { {
    ...
    qt_meta_stringdata_ParamDialog.offsetsAndSize,
    qt_meta_data_ParamDialog,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_ParamDialog_t
